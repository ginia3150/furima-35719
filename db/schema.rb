...
ActiveRecord::Schema.define(version: 2021_06_03_093557) do
  ...
  create_table "postal_codes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_history_id"], name: "index_postal_codes_on_purchase_history_id"
  end
  ...
  add_foreign_key "postal_codes", "purchase_histories"
